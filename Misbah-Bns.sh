...
echo
echo $pur"==================="$cy" ============================="
echo $i""$pu"  AUTHOR  :  Misbah-Bns  "$i"                    "
echo $i""$pu"  WhatsApp:  087833469538"$i"                "
echo $i""$pu"  GMAIL   :  termuxcyberteam@gmail.com"$i"     "
echo $i""$pu"  YOUTUBE :  Termux Cyber Team"$i"                 "
echo $pur"==================="$cy" ============================="
echo
...
sleep 2
echo $ku"Facebook :"$i" Pro Gans"
echo $ku"YouTube  :"$i" Termux Cyber Team"
echo $ku"WhatsApp :"$i" 087833469538"
sleep 2
echo $pur"Terima kasih Yang Sudah Support dengan Tools ini"
sleep 2
echo $pur"SUBSCRIBE MY CHANNEL { Termux Cyber Team }"
exit
fi
